...
public class OrderServiceImpl implements OrderService{
	...
	public OrderResponseDTO createOrder(CreateOrderRequestDTO dto) {
        ...
        try {
        	...
        	InventoryResponseDTO reserveStock = inventoryClient.reserveStock(new StockRequestDTO(dto.productId(), dto.quantity()));
        	...
        	if(paymentSuccess) {
        		...
        		InventoryResponseDTO confirmStock = inventoryClient.confirmStock(new StockRequestDTO(dto.productId(), dto.quantity()));
        		log.info("Stock confirm for productId={}", dto.productId(),confirmStock);
        		savedOrder.setStatus(OrderStatus.CONFIRMED);
        		
        	}else {
        		
        		InventoryResponseDTO releaseStock = inventoryClient.releaseStock(new StockRequestDTO(dto.productId(), dto.quantity()));
            ...
            inventoryClient.releaseStock(
                    new StockRequestDTO(dto.productId(), dto.quantity())
            );
